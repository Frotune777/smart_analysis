...
**Primary**: Screener.in + NSE
**Broker**: Only for execution
```python
...
**Primary**: Broker API WebSocket
**Secondary**: NSE for backtesting
```python
...
### Keep Using NSE For:
1. Daily historical (>5-10 years)
2. FII/DII activity
3. Bulk & Block deals
4. Insider trading
5. Corporate actions
6. Official market statistics
